...
fane_1= Fane.new(title: "mongomeri", brand: "Dyson", start_date: "22/04/2023", end_date: "24/09/2023", validation: nil, user_id: @thomas.id, address: "20 rue des capucins, 69001 lyon ", description: "Ventilateur de Plafond Silencieux et Élégant :
...
fane_3= Fane.new(title: "pipette", brand: "Dyson", start_date: "22/04/2023", end_date: "24/09/2023", validation: nil, user_id: @thomas.id,address: "19 rue benoit tabard, 69130 ecully", description: "Ventilateur de Plafond Silencieux et Élégant :
Transformez votre espace en un havre de fraîcheur avec notre ventilateur de plafond ultra-silencieux. Sa conception élégante s'intègre parfaitement à n'importe quel intérieur tout en offrant une circulation d'air optimale.")
file = URI.open("https://www.festihome.com/img/cms/images-conseils/4%20conseils%20pour%20bien%20utiliser%20son%20ventilateur/ventilateur-bronze.jpg")
...
fane_5= Fane.new(title: "clochette", brand: "Dyson", start_date: "22/04/2023", end_date: "24/09/2023", validation: nil, user_id: @thomas.id,address: "30 rue des capucins, 69001 Lyon", description: "Ventilateur de Plafond Silencieux et Élégant :
Transformez votre espace en un havre de fraîcheur avec notre ventilateur de plafond ultra-silencieux. Sa conception élégante s'intègre parfaitement à n'importe quel intérieur tout en offrant une circulation d'air optimale.")
file = URI.open("https://www.festihome.com/img/cms/images-conseils/4%20conseils%20pour%20bien%20utiliser%20son%20ventilateur/ventilateur-bronze.jpg")
